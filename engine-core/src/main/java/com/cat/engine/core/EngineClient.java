...
public class EngineClient {
    ...
    public <T> T getInterfaceByName(String instanceName) {
        ...
        try {
            ...
            log.error("EngineClient#getInterfaceByName get script name {} fail! e:{}", instanceName, Throwables.getStackTraceAsString(e));
        }
        return bean;
    }
    ...
    public GroovyObject getGroovyObjectByName(String instanceName) {
        ...
        try {
            ...
            log.error("EngineClient#getGroovyObjectByName get script name {} fail! e:{}", instanceName, Throwables.getStackTraceAsString(e));
        }
        return groovyObject;
    }
    ...
    public Object execute(String instanceName, String methodName, Object[] params) {
        ...
        try {
            ...
            log.error("EngineClient#execute fail! instanceName:[{}],methodName:[{}],params:[{}],exception:{}", instanceName, methodName, params, Throwables.getStackTraceAsString(e));
        }
        return resultObj;
    }
}
